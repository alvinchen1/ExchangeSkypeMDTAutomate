...
Function Install-SfB-AdminTools
{
    ...
    Else 
    {
        ...
        Start-Process "C:\Program Files\Skype for Business Server 2019\Deployment\Bootstrapper.exe" -Wait -Argumentlist "/BootstrapAdminTools /SourceDirectory:`"$Skype4BusinessPath\Setup\amd64`""
    }
}
...
Function New-SfB-RTC
{
    ...
    {
        Write-Host "Installing SQL Express Instance RTC" -ForegroundColor Green
        Test-FilePath ("C:\Program Files\Skype for Business Server 2019\Deployment\Bootstrapper.exe")
        Test-FilePath ("$Skype4BusinessPath\Setup\amd64")
        Start-Process -FilePath "C:\Program Files\Skype for Business Server 2019\Deployment\Bootstrapper.exe" -ArgumentList "/BootstrapSQLExpress /SourceDirectory:`"$Skype4BusinessPath\Setup\amd64`"" -Wait
    ...
    Else 
    {
        Write-Host "SQL Express Instance RTC already exists." -ForegroundColor Green
    }
}
