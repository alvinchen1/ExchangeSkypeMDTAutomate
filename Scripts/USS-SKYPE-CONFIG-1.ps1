...
Start-Transcript -Path C:\Windows\Temp\MDT-PS-LOGS\USS-SKYPE-CONFIG-1.log
Start-Transcript -Path \\DEV-MDT-01\DEPLOYMENTSHARE$\LOGS\$env:COMPUTERNAME\USS-SKYPE-CONFIG-1.log
