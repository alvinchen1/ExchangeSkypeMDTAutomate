...
Install-WindowsFeature -Name BitLocker,Web-Server,Web-Dir-Browsing,ADCS-Online-Cert,RSAT-AD-PowerShell,SNMP-Service,SNMP-WMI-Provider -IncludeManagementTools
